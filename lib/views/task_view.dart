...
class _TaskViewState extends State<TaskView> {
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: FutureBuilder<UserModel?>(
            future: profileController.getUserData(), // Get instance of Future<UserModel?>
                                ...
                                Row(
                                  children: [
                                    IconButton(
                                      ...
                                      icon: Icon(
                                        Icons.edit,
                                        color: edit ? Colors.red : const Color(
                                            0xff4E5058),
                                        size: 28,
                                      ),
                                    ),
                                  ...
                                  edit ? InkWell(
                                    onTap: () {
                                      FirebaseFirestore.instance.collection(
                                          "Users")
                                          .doc(userId).collection("Todo").doc(
                                          widget.id).update({
  ...
  Widget button() {
    return InkWell(
      onTap: () {
        FirebaseFirestore.instance.collection("Users").doc().collection("Todo").doc(widget.id).update({
          "title": _titleController.text,
          "task": _type,
          "category": _category,
  ...
  Widget itemSelect(String label, String itemType) {
    return InkWell(
      ...
      child: Chip(
        ...
        backgroundColor: _category == label || _type == label ? const Color(0xFF2196F3) : const Color(0xFFbdebff),
        label: Text(label),
        labelStyle: TextStyle(
          color: _category == label || _type == label ? Colors.white : const Color(0xff167bdf),
          fontSize: 15,
          fontWeight: FontWeight.w600,
        ),
